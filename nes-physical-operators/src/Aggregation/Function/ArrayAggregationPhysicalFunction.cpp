    ...
    AggregationPhysicalFunctionRegistryArguments arguments)
{
    ...
    const std::shared_ptr<Nautilus::Interface::BufferRef::TupleBufferRef> memoryProvider
        = std::make_shared<Nautilus::Interface::BufferRef::ColumnTupleBufferRef>(layout);
