...
{
    Reflected operator()(const NearestApproachDistanceLogicalFunction& function, const ReflectionContext& context) const;
};

template <>
struct Unreflector<NearestApproachDistanceLogicalFunction>
{
    NearestApproachDistanceLogicalFunction operator()(const Reflected& reflected, const ReflectionContext& context) const;
};
